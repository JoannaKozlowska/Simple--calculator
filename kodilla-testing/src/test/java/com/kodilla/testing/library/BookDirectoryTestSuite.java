...
public class BookDirectoryTestSuite {
    ...
    public void testUserHasZeroBooks() {
        ...
        LibraryDatabase libraryDatabaseMock = mock(LibraryDatabase.class);
        BookLibrary bookLibrary = new BookLibrary(libraryDatabaseMock);
        List<Book> borrowedListOf0Books = new ArrayList<>();
        LibraryUser libraryUser = new LibraryUser("Asia", "Kozlowska", "12345678");
        when(libraryDatabaseMock.listBooksInHandsOf(libraryUser)).thenReturn(borrowedListOf0Books);
        //When
    ...
    public void testUserHasOneBook() {
        ...
        LibraryDatabase libraryDatabaseMock = mock(LibraryDatabase.class);
        BookLibrary bookLibrary = new BookLibrary(libraryDatabaseMock);
        List<Book> borrowedListOf1Books = generateListOfNBooks(1);
        LibraryUser libraryUser = new LibraryUser("Asia", "Kozlowska", "12345678");
        when(libraryDatabaseMock.listBooksInHandsOf(libraryUser)).thenReturn(borrowedListOf1Books);
        //When
    ...
    public void testUserHasFiveBooks() {
        ...
        LibraryDatabase libraryDatabaseMock = mock(LibraryDatabase.class);
        BookLibrary bookLibrary = new BookLibrary(libraryDatabaseMock);
        List<Book> borrowedListOf5Books = generateListOfNBooks(5);
        LibraryUser libraryUser = new LibraryUser("Asia", "Kozlowska", "12345678");
        when(libraryDatabaseMock.listBooksInHandsOf(libraryUser)).thenReturn(borrowedListOf5Books);
        //When
