...
public class ShapeFactoryTestSuite {
    ...
    public void testFactoryCircle() {
        ...
        //Then
        Assert.assertEquals(Math.PI * Math.pow(4.5,2.0 ), circle.getArea(),0.001);
    ...
    public void testFactorySquare() {
        ...
        //Then
        Assert.assertEquals(28.0, square.getCircumference(),0.001);
    ...
    public void testFactoryRectangle() {
        ...
        //Then
        Assert.assertEquals(37.5, rectangle.getArea(), 0.001);
